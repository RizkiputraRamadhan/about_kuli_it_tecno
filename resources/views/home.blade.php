...
@section('content')
        ...
        <main class="px-8 sm:px-24 z-10 sm:w-2/3">
            <div class="">
                ...
                <p class="mt-3 text-white sm:mt-5 sm:max-w-xl md:mt-5 text-lg font-light">
                    ...
                    bermanfaat, sekaligus penyedia jasa pembuatann system dalam berbagai bidang. <br>
                </p>
    ...
    @include('includes.fitures')
    @include('includes.step')
    @include('includes.banefit')
    @include('includes.list-project')
