            ...
            <div
                ...
                <div class="md:max-w-md w-full px-4 py-4">
                    ...
                    <form action="/register" method="POST">
                        @csrf
                        <div class="mb-12">
                            <h3 class="text-gray-800 text-3xl font-extrabold">Daftar</h3>
                            <p class="text-sm mt-4 text-gray-800">Sudah punya akun ? <a href="/login"
                                    class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Masuk</a></p>
                            @if ($errors->any())
                                <div role="alert"
                        ...
                        <div>
                            <label class="text-gray-800 text-xs block mb-2">Nama Lengkap</label>
